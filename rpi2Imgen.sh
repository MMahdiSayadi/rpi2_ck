...
sudo mkdir $varpath1/finalsdcard $varpath1/mntp $varpath1/apps 


# Download the content inside of the sdcard 
#sudo wget https://github.com/MMahdiSayadi/rpi2_ck/blob/main/sdcard/bcm2709-rpi-2-b.dtb -P $varpath1/sdcard
#sudo wget https://github.com/MMahdiSayadi/rpi2_ck/blob/main/sdcard/bootcode.bin -P $varpath1/sdcard
#sudo wget https://github.com/MMahdiSayadi/rpi2_ck/blob/main/sdcard/config.txt -P $varpath1/sdcard
#sudo wget https://github.com/MMahdiSayadi/rpi2_ck/blob/main/sdcard/fixup.dat -P $varpath1/sdcard
#sudo wget https://github.com/MMahdiSayadi/rpi2_ck/blob/main/sdcard/start.elf -P $varpath1/sdcard

sudo git clone https://github.com/MMahdiSayadi/rpi2_ck.git $varpath1/rpi2clone
sudo mv $varpath1/rpi2clone/main.c $varpath1/apps
sudo mv $varpath1/rpi2clone/sdcard $varpath1
sudo rm -r $varpath1/rpi2clone

#download the crosstool-ng without make it 
sudo wget http://crosstool-ng.org/download/crosstool-ng/crosstool-ng-1.25.0_rc1.tar.xz -P $varpath1
...
sudo gcc $varpath1/apps/main.c -o $varpath1/apps/app 
